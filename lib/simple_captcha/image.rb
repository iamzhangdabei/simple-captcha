  ...
  module ImageHelpers #:nodoc
    ...
    def append_simple_captcha_code #:nodoc      
      @image.combine_options do |c|
        c.gravity 'Center'
        c.fill("red")
        text = simple_captcha_value(@simple_captcha_image_options[:simple_captcha_key])
    ...
    def generate_simple_captcha_image(options={})  #:nodoc
      @image =MiniMagick::Image.open("#{RAILS_ROOT}/vendor/plugins/simple_captcha/assets/images/back.jpg")
